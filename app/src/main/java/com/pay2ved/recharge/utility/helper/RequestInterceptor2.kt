package com.jmcpapertech.jmcapp.utility.helper
...
class RequestInterceptor2(private val onRequestInterceptor: OnRequestInterceptor) : Interceptor {

    interface OnRequestInterceptor {
        fun provideBodyMap(): HashMap<String, String>
        fun provideHeaderMap(url: String): HashMap<String, String>
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        if (method == "GET") {
            ...
            if (requestBody != null) {
                ...
                when (request.body) {
                    is FormBody -> { // if request body is FORM
                        // BODY
                    ...
                    is MultipartBody -> { //if request body is MULTIPART BODY
        ...
        val headerMap = onRequestInterceptor.provideHeaderMap(request.url.toString())
